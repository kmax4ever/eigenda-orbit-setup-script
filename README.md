...
3. Then, add the private key for the wallet you used to deploy the rollup contracts earlier in the following command, and run it: `PRIVATE_KEY="YourPrivateKey" PARENT_CHAIN_RPC_URL="<https://sepolia-rollup.arbitrum.io/rpc>" ORBIT_RPC_URL="http://localhost:8449" yarn run setup`
